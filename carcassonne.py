...
async def main():
    global camera_x, camera_y, zoom_scale, is_dragging_cam, drag_origin_x, drag_origin_y
    global active_tile, game_state, last_placed_pos, score, meeple_count, score_effects
    global history_log, show_history, history_scroll
